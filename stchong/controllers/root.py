...
from stchong.model import Ship
...
from stchong.controllers.ship import ShipController
from stchong.controllers.invite import InviteController
from stchong.controllers.myMonster import MyMonsterController
...
from stchong.controllers.ship import *
from stchong.controllers.monster import *
...
class RootController(BaseController):
    ...
    shipc = ShipController()
    invite = InviteController()
    monsterc = MonsterController()
    myMonsterc = MyMonsterController()
    ...
    #coin food wood caesars exp buildTime specials size 
    [6000, 350, 0, 0, 23, 8*3600, None, 0],
    [8300, 0, 250, 15, 35, 8*3600, 'a,5', 0],
    [10500, 0, -250, 18, 45, 8*3600, 'b,5', 0],
    [7500, 550, 0, 0, 25, 10*3600, None, 0],
    [8900, 0, 270, 17, 37, 12*3600, 'c,5', 0],
    [20000, 0, -270, 20, 48, 14*3600, 'd,5', 0],
    [1400, 55, 0, 0, 4, 1200, None, 0],
    [4700, 110, 0, 5, 11, 4680, 'b,2;d,2', 0],
    [8800, 0, 90, 9, 22, 9360, 'c,2;e,4', 0],
    [-8, 0, 0, 0, 15, 6480, None, 0],
    [18000, 0, 280, 18, 25, 13320, 'b,2;c,2', 0],
    [23000, 0, -280, 20, 40, 25200, 'c,2;d,3', 0],
    ]

    resourcebuild=[[1000,0,80,0,5,0],[-20,0,0,0,15,10],[-50,0,0,0,40,20],[-100,0,0,0,70,30],[10000,600,120,0,20,10],[28500,1000,250,0,30,18]]
    ...
    [10000, 200, 70, 0, 0, 17, 8*3600, None, 0],
    [15000, 0, 15, 280, 21, 19, 10*3600, 'a,5', 0],
    [24000, 0, 20, -280, 23, 21, 10*3600, 'b,5', 0],
    [15000, 300, 90, 0, 0, 19, 10*3600, None, 0],
    [18000, 0, 25, 300, 23, 21, 12*3600, 'c,5', 0],
    [27000, 0, 40, -300, 25, 23, 14*3600, 'd,5', 0],
    #coin food person wood cae bexp time spe level
    [1100, 40, 30, 0, 0, 4, 2700, None, 0],
    [1700, 0, 7, 100, 4, 8, 7200, 'a,2;c,2', 0],
    [2800, 0, 15, -100, 7, 13, 14400, 'b,2;d,3', 0],
    [-8, 0, 0, 0, 0, 14, 1800, None, 0],
    [4500, 0, 0, 110, 9, 19, 10800, 'b,2;e,2', 0],
    [6500, 0, 0, -120, 14, 24, 21600, 'a,2;d,3', 0],
    ]
    #coin food pop
...
#    statuebuilding = [[12,10000,600,10,7200],[12,-10,700,10,14400],[13,20000,1150,10,21600],[13,-20,1300,10,28800],[15,50000,3000,10,36000],[15,-50,3200,10,43200]]
    statuebuilding = [[12,10000,600,10,7200],[12,-10,700,10,14400],[13,20000,1150,10,21600],[13,-20,1300,10,28800],[15,50000,3000,10,36000],[15,-50,3200,10,43200], [20, 80000, 4000, 10, 36000], [20, -80, 4400, 10, 43200]]
    #corn person level
    ...
    [-6, 28, 0], [800, 15, 0], [150, 7, 0], [-3, 27, 0], [1000, 17, 0],
    ]
    ...
    houses = [[10, 20, 1, 1800], [15, 30, 2, 1800], [20, 40, 3, 1800], [10, 20, 1, 1800], [15, 30, 2, 1800], [20, 40, 3, 1800], [10, 20, 1, 1800], [15, 30, 2, 1800], [20, 40, 3, 1800], [10, 20, 1, 1800], [15, 30, 2, 1800], [20, 40, 3, 1800], [32, 64, 3, 7560], [43, 86, 5, 7560], [55, 110, 7, 7560], [32, 64, 3, 7560], [43, 86, 5, 7560], [55, 110, 7, 7560], [32, 64, 3, 7560], [43, 86, 5, 7560], [55, 110, 7, 7560], [32, 64, 3, 7560], [43, 86, 5, 7560], [55, 110, 7, 7560], [70, 140, 7, 18720], [83, 174, 9, 18720], [100, 200, 11, 18720], [70, 140, 7, 18720], [83, 174, 9, 18720], [100, 200, 11, 18720], [70, 140, 7, 18720], [83, 174, 9, 18720], [100, 200, 11, 18720], [70, 140, 7, 18720], [83, 174, 9, 18720], [100, 200, 11, 18720], [50, 90, 7, 12600], [62, 116, 9, 12600], [75, 142, 11, 12600], [50, 90, 7, 12600], [62, 116, 9, 12600], [75, 142, 11, 12600], [50, 90, 7, 12600], [62, 116, 9, 12600], [75, 142, 11, 12600], [50, 90, 7, 12600], [62, 116, 9, 12600], [75, 142, 11, 12600], [95, 190, 13, 29880], [115, 230, 15, 29880], [135, 270, 17, 29880], [95, 190, 13, 29880], [115, 230, 15, 29880], [135, 270, 17, 29880], [95, 190, 13, 29880], [115, 230, 15, 29880], [135, 270, 17, 29880], [95, 190, 13, 29880], [115, 230, 15, 29880], [135, 270, 17, 29880], [100, 150, 15, 14400], [150, 225, 17, 14400], [200, 300, 19, 14400], [100, 150, 15, 14400], [150, 225, 17, 14400], [200, 300, 19, 14400], [100, 150, 15, 14400], [150, 225, 17, 14400], [200, 300, 19, 14400], [100, 150, 15, 14400], [150, 225, 17, 14400], [200, 300, 19, 14400], [50, 75, 9, 5400], [72, 112, 11, 5400], [100, 150, 13, 5400], [47, 140, 19, 10800], [68, 214, 21, 10800], [190, 290, 23, 10800], [90, 275, 17, 21600], [134, 416, 19, 21600], [370, 538, 21, 21600],
    #population food exp time 
    [65, 130, 7, 8*3600], [73, 146, 9, 8*3600], [81, 162, 11, 8*3600],
    [80, 160, 11, 12*3600], [100, 200, 13, 12*3600], [120, 240, 15, 12*3600],
    [30, 60, 2, 6840], [40, 80, 4, 6840], [50, 100, 6, 6840],
    [80, 150, 6, 10800], [120, 220, 8, 10800], [160, 300, 10, 10800],
    ]
    ...
    appsecret = 'UYvYJaNN49eL4f71c424'
    ...
    def levup(self,uid,lev):
        ...
        if lev == 4:
            try:
                conn = urllib.urlopen("http://papayamobile.com/a/misc/third_party_event?uid="+u.otherid+"&event=80")
                res = conn.read()
                print "reg success", res
            except:
                print "reg error"
    ...
    def getfriend(self,userid,otherid,user_kind):
        ...
        try:
            ...
            rankYet = db.rankYet.find_one({'uid':userid, 'oid':u.userid}) 
            if rankYet != None:
                rankYet = 1
            else:
                rankYet = 0
            return dict(rankYet = rankYet, loginNum = u.logincard, money = u.corn, id=otherid, sub=sub,cardlist=cardlist,monsterdefeat=u.monsterdefeat,hid=u.hid,power=u.infantrypower+u.cavalrypower,casubno=u.subno,empirename=u.empirename,minusstr=uw.minusstate,allyupbound=u.allyupbound,frienduserid=u.userid,city_id=uw.city_id,visited=i,corn=bonus,stri=readstr,friends=u.treasurebox,lev=u.lev,nobility=u.nobility,treasurenum=u.treasurenum,time=int(time.mktime(time.localtime())-time.mktime(beginTime)))
        except InvalidRequestError:
            ...
            if rankYet != None:
                ...
                rankYet = 0
            return dict(rankYet = rankYet, loginNum = u.logincard, money = u.corn, id=otherid, cardlist=cardlist,monsterdefeat=u.monsterdefeat,hid=u.hid,power=u.infantrypower+u.cavalrypower,casubno=u.subno,empirename=u.empirename,minusstr=uw.minusstate,frienduserid=u.userid,city_id=uw.city_id,visited=0,corn=85+15*(dv.visitnum),stri=readstr,friends=u.treasurebox,lev=u.lev,nobility=u.nobility,treasurenum=u.treasurenum,time=int(time.mktime(time.localtime())-time.mktime(beginTime)))
    @expose('json')
    ...
    def moveMap(uid):
        ...
        if kind >= 3:
            ...
            mapNum = 'select mapid, num from (select mapid, map_kind, count(*) as num from warMap group by mapid) as temp where map_kind = '+str(kind)+ ' and  num < ' + str(mapKind[kind])
        try:
    ...
    def logsign(self,papayaid,user_kind,md5):
        ...
        try:
            ...
            #c1=DBSession.query('LAST_INSERT_ID()')
            #c1=c1[0]
            ship = returnShip(newuser.userid)
            ...
            try:
                nuf=DBSession.query(Papayafriend).filter_by(papayaid=papayaid).all()
                for x in nuf:
                    x.lev=1
            ...
            return dict(ship = ship, week = todayWeek.tm_wday, wonNum = 0, wonBonus = 0, ppyname=nu.papayaname,infantrypower=nu.infantrypower,cavalrypower=nu.cavalrypower,castlelev=nu.castlelev,newstate=0,popupbound=nu.populationupbound,wood=nu.wood,stone=nu.stone,specialgoods= getUserSpe(nu.userid), time=nu.logintime,labor_num=280,nobility=0,population=380,food=100,corn=1000,cae=nu.cae,exp=0,stri=inistr,id=newuser.userid,city_id=cid.city_id,mapid=mi,gridid=gi,mana=mana,boundary=boundary,lasttime=lasttime)
    ...
    def allyhelp(uid,type,poweru):
        ...
        try:
            ...
            for a in allyset :
                ...
                if f == None:
                    continue
                helpSoldier = returnsentouryoku(f)
                if helpSoldier < 0:
                    helpSoldier = 0
                if int((helpSoldier+20-1)/20)>int((poweru+10-1)/10):
                    fullpower += int((poweru+10-1)/10)
                else:
                    fullpower += int((helpSoldier+20-1)/20)
            return fullpower
        except InvalidRequestError:
            return 0 
    @expose('json')
    ...
    def attack(self,uid,enemy_id,timeneed,infantry,cavalry,catapult):
        ...
        if timeneed < 0 or infantry < 0 or cavalry < 0 or catapult < 0:
            return dict(id = 0, reason = 'sol < 0')
        if enemy_id < 0:
    ...
    def callost(myFull, eneFull, myPure, enePure, type):
    	lost = [0, 0]
    	attackLost = [[45, 55, 75, 95], [20, 25, 25, 25] ]
        defenceLost = [[40, 40, 40, 40], [25, 35, 50, 50] ]
    ...
    def warinfo(self,userid):
        ...
        monster = getMonster(userid, m.mapid).get("monster")
        return dict(monster = monster, empty = emptyInfo['empty'], sub=sub,wartask=wwartask,protect=userprotect,mapid=m.mapid,newstr=newstr,infantrypower=u.infantrypower,cavalrypower=u.cavalrypower,citydefence=u.defencepower, time=t,gridid=m.gridid,monsterstr=u.monsterlist,nobility=nobility1,subno=subno,won=won,lost=lost,list=listuser)
...
#                        u.cae -= caeCost[caetype]
                        ...
                        b.producttime = t
                        b.object_id = caetype
                        statues = DBSession.query(businessWrite).filter("businessWrite.city_id=:cid and ground_id >= 600 and ground_id <= 699 and finish = 1").params(cid=warmap.city_id).all()
                        for s in statues:
                            s.producttime = t
                            s.object_id = caetype
    ...
    def updateRoom(user, p, ti, type):
        ...
        if user.corn >= coinCost and user.food >= cost[1] and user.cae >= caeCost and user.wood >= woodCost and user.stone >= stoneCost and  checkSpe(speCost, spe):
            ...
            p.producttime = ti 
            p.object_id = -1
            #print "updateRoom", coinCost, cost[1], caeCost, woodCost, stoneCost, speCost
            return dict(id=1, result='room upgrade')
        return dict(id=0)

    #coin food person wood cae bexp time spe level
    global updateBusiness
    def updateBusiness(user, p, ti, type):
        print "updatebusi", p.ground_id
        ground_id = (p.ground_id+1)%100
        lev = ground_id%3
        if lev <= (p.ground_id%100)%3:
            return dict(id=0, reason="leve not right")
        cost = businessbuild[ground_id]
        print "busi cost", cost
        coinCost = 0
        caeCost = 0
        perCost = 0
        woodCost = 0
        ...
        if type == 0:
            ...
            if cost[3] > 0:
                ...
                stoneCost = -cost[3]
            speCost = speStr2Arr(cost[7])

        spe = getSpecial(user)
        if user.corn >= coinCost and user.food >= cost[1] and (user.population-user.labor_num) >= perCost and user.cae >= caeCost and user.wood >= woodCost and user.stone >= stoneCost and  checkSpe(speCost, spe):
            user.corn -= coinCost
            user.food -= cost[1]
            user.labor_num += perCost
            user.cae -= caeCost
            user.wood -= woodCost
            user.stone -= stoneCost
            spe = costSpe(speCost, spe)
            ...
            p.object_id = -1
            #print "updateRoom", coinCost, cost[1], caeCost, woodCost, stoneCost, speCost
            return dict(id=1, result='fact upgrade')
        return dict(id=0, reason = 'resource')
    global getSpeCost
    ...
    def updatebuilding(self,user_id,city_id,ground_id,grid_id,type):
        ...
        print "updatebuilding", ground_id
        try:
            ca=0
            cae=0
            price=0
            ...
            #    return updateBusiness(u, p, ti, type)
    ...
    friendGod = [[2*3600, 500, 10000, 50, 100,  0], [6*3600, 1000, 20000, 100, 100, 29], [12*3600, 2000, 50000, 170, 100, 49], [18*3600, 5000, 100000, 250, 100, 99], [24*3600, 10000, 500000, 350, 100, 199]]
...
#    monGodReward = [[8,12,16,20,24],[30,35,40,45,50],[12,16,20,24,28],[40,45,50,55,60],[20,24,28,32,36],[60,65,70,75,80]]
    monGodReward = [[8,10,12,14,16],[10,12,14,16,18],[12,14,16,18,20],[15,17,19,21,23],[16,18,20,22,24],[20,22,24,26,28], [22, 24, 25, 27, 29], [27, 29, 31, 33, 35]]
    global initH
    global addHealth
    global growUp
    global reward
    ...
    def buildBusiness(user, city_id, ground_id, grid_id):
        ...
        return dict(id=0, reason = 'business/mil fail', coinCost=coinCost, cae = caeCost, cost = cost)
    ...
    def build(self,user_id,city_id,ground_id,grid_id):
        ...
        if ground_id >=600 and ground_id <=699:
    ...
    global HarvestGod
    HarvestGod = [1.2, 1.4, 1.6, 1.8, 2.0]
    global FarmExtra
    FarmExtra = [1.0, 1.2, 1.4, 1.6]
    """
    global getPlantAct
    def getPlantAct(uid):
        act = db.rank.find_one({'uid': uid})
    ...
    def changePlantFood(uid, inc):
        ...
        return
    """
    global getHarFactor1
    def getHarFactor1(u, t):
        god = u.food_god - 1
        lev = u.food_god_lev - 1
        factor = 1
        if god >= 0 and god < len(HarvestTime) and t-u.foodgodtime < HarvestTime[god] and lev >= 0 and lev < len(HarvestGod) :
            factor = HarvestGod[lev]
        else:
            u.food_god = 0
            u.foodgodtime = -1
        return factor

    global getHarFactor2
    def getHarFactor2(p):
        factor2 = 1
        farmKind = p.ground_id - 1
        if farmKind >= 0 and farmKind < len(FarmExtra):
    ...
    def harvest(self,user_id,city_id,grid_id,type):
        ...
        factor = getHarFactor1(u, t)
        factor2 = getHarFactor2(p)
...
#                    temp_cae=temp_cae+1
    ...
    def rankHeart(self, uid, oid):
        ...
        if rankYet == None:
            ...
            fri = db.rank.find_one({'uid':oid})
            if fri == None:
                fri = {'uid':oid, 'heart':0, 'order':1000}
            if fri.get('heart', None) == None:
                fir['heart'] = 0
            fri['heart'] += 1
...
#                    u.cae=u.cae-caesars
    ...
    def training(self,user_id,city_id,grid_id,sid):
        try:
           ...
           if u.corn-corn>=0 and u.food-foo>=0 and u.population-pop>=u.labor_num and p.producttime==0 and p.finish==1:
            ...
            return dict(id=0)
    global CataSpe
    CataSpe = [[['a', 5], ['b', 5]], [['a', 8], ['c', 8]], [['g', 12], ['i', 12]] ]
    @expose('json')
    ...
    def addppyfriend(self,uid,rrstring):
        ...
        try:
            ...
            print "addppyfriend error", uid, rrstring
            return dict(id=0)         
